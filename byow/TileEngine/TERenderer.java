...
public class TERenderer implements Serializable {
     ...
     */
    public void renderFrame(TETile[][] world, String lHUD, String cHUD) {
        ...
        StdDraw.textLeft(1, height - 1.25, lHUD);
        StdDraw.text((double) width / 2, height - 1.20, cHUD);
        for (int x = 0; x < numXTiles; x += 1) {
            for (int y = 0; y < numYTiles; y += 1) {
                ...
                if (Math.floor(StdDraw.mouseX()) == (double) x
                        && Math.floor(StdDraw.mouseY()) == (double) y) {
                    StdDraw.setPenColor(Color.WHITE);
                    StdDraw.textRight(width - 1, height - 1.20, world[x][y].description());
                }
